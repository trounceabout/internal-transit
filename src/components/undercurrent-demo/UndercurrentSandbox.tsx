...
export default function UndercurrentSandbox() {
  ...
  return (
    <div
      className="uc-demo mt-10 flex flex-col items-center gap-6 rounded-xl border bg-white p-6 dark:bg-neutral-900"
      data-uc-variant={variant}
      style={{
        borderColor:
          "color-mix(in oklch, var(--uc-demo-active-border-main) 50%, transparent)",
      }}
    >
      ...
      <div className="flex w-full flex-col items-center gap-6">
        <UcNote>
          This is a note, a string of text that may contain a link action
        </UcNote>
          ...
          <div className="flex min-w-0 flex-1 flex-col gap-6 sm:w-1/2">
            <div className="flex items-center gap-4">
              <UcDynamicBadge
                ...
                primaryInfo="Deploying"
                secondaryInfo="Installing OS ..."
              />
              <UcChip>New</UcChip>
