...
export default function UcDynamicBadge({
  primaryInfo,
  secondaryInfo,
  className,
}: UcDynamicBadgeProps) {
  return (
    <div
      className={cn(
        "flex h-[var(--uc-demo-size-md)] max-w-full min-w-0 items-center gap-[var(--uc-demo-space-100)] rounded-[var(--uc-demo-radius-full)] border-2 p-[var(--uc-demo-space-100)]",
        className,
      )}
      style={{
        ...
        boxShadow:
          "0px 2px 2px rgba(0,0,0,0.15), 0px 0px 0.25px rgba(0,0,0,0.25)",
      }}
    >
      <Ship
        size={16}
      ...
      <span
        ...
        style={{
          color: "var(--uc-demo-neutral-text-medium)",
