...
export default function UcButton({
  ...
  return (
    <button
      type="button"
      className="inline-flex h-[var(--uc-demo-size-lg)] flex-1 items-center justify-center gap-[var(--uc-demo-space-100)] rounded-[var(--uc-demo-radius-full)] px-[var(--uc-demo-space-200)] py-[var(--uc-demo-space-100)] text-sm font-medium"
      style={{
